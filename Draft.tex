...
\begin{boxtheorem}{Theorem 1: Quantum Diffusion}
...
that by \hyperref[3.1]{(3.1)} and  \hyperref[lemma-a1]{Lemma A.1}, $1-|m(z)|^2\asymp \eta\Leftrightarrow \exists \alpha, 1-|m(z)|^2\leq \alpha\eta$, we have that: 
...
If we recall the phenomenology of our \hyperref[model]{model}
