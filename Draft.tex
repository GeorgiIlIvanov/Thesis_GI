...
\item These estimates will allow us to prove the following theorem in \hyperref[proof-stop]{Section 7.1}:
...
that by \hyperref[3.1]{(3.1)} and  \hyperref[lemma-a1]{Lemma A.1}, $1-|m(z)|^2\asymp \eta\Leftrightarrow \exists \alpha>0, 1-|m(z)|^2\geq \alpha\eta$, we have that: 
