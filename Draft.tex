...
\noindent Recall the resolvent identities we proved in Section 2, namely $\partial_{H_{ij}}G_{xy} = -G_{xi}G_{jy}$ and $\partial_{\overline{H_{ij}}}\overline{G_{xy}} = -\overline{G_{xi}}\ \overline{G_{jy}}$. Substituting the derivatives into our chain rule expression yields:
...
That said, our work of calculating up to the third derivative isn't wasted, because now we can make an educated guess as to the form that all subsequent steps would take. Namely, we should expect: 
