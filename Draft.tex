...
$$=\max_{\alpha\beta}\int_0^{\tau_\sto\wedge}\sum_{x, x', u, v}\left(G^*S^{\frac{1}{2}, \alpha}GG^*S^{\frac{1}{2},\alpha}G\right)_{uu}S_{uv}|G_{v\beta}|^2ds$$
By first applying the \hyperref[ward]{Ward identity} and the operator norm bound $\|G\|_{op}\leq \eta_s^{-1}$, we have: 
...
$$\lesssim W^{-1}\eta_s^{-2}(G^*S^{\frac{1}{2}, \alpha}G)_{uu} = W^{-1}\eta_s^{-2}\sum_\gamma S^{\frac{1}{2}}_{\alpha\gamma}|G_{\gamma\beta}|^2$$
Now, in both the display after $(6.2)$ and the one above we have terms of the form $S|G|^2$. 


As such, we get a combined bound $$\left[\E_t^{M, 14}(z)\right] $$ 

$$\lesssim \max_{\alpha, \beta}\int_0^{\tau_\sto\wedge t} W^{\frac{\delta_\sto}{10}}W^{-1}\eta_s^{\frac{1}{2}}$$
