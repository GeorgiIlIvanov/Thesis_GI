...
by Boole's inequality. Now, this means that we, need to find $\gamma$ and $N_0'$, s.t. $\forall N\geq N_0'$:

$$N^\gamma\gg \frac{N^{\delta\epsilon}}{1-N^{\delta\epsilon-\frac{1+2\beta}{4}}}$$
