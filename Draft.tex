...
where $Z_{N, W}\asymp W$ is a normalizing constant bounded deterministically above and below by $W$. A technical, but necessary assumption is for $S$ to admit a matrix square root $S^{1/2}$, satisfying the same properties for a similarly symmetric and compactly supported PDF $f'$. \vspace{0.5 cm}
\begin{center}
\begin{tikzpicture}
    % Define parameters
    \def\n{4} % Matrix dimension
