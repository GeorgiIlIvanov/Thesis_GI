...
$$\frac{\partial |W_{ij}|^{2p}}{\partial H_{kl}} = p|W_{ij}|^{2p-2} \cdot \overline{W_{ij}} \cdot 1 \cdot (-G_{ik}G_{lj}) + p|W_{ij}|^{2p-2} \cdot W_{ij} \cdot 1 \cdot (-G_{ik}^*G_{lj}^*)$$

Simplifying:

$$\frac{\partial |W_{ij}|^{2p}}{\partial H_{kl}} = -p|W_{ij}|^{2p-2} \cdot [\overline{W_{ij}} \cdot G_{ik}G_{lj} + W_{ij} \cdot G_{ik}^*G_{lj}^*]$$
