...
$$\E_t^{M}(z)=-\int_0^t \{\text{Id} + (t-s)\Theta_t\}S^{1/2} dM(s)S^{1/2}\{\text{Id} +(t-s)\Theta_t\}$$
...
$$\E_t^{D, \sto}(z)=\int_0^{t\wedge\tau_\sto} \{\text{Id} + (t-s)\Theta_t\} S^{1/2} \Omega(s) S^{1/2} \{\text{Id} + (t-s)\Theta_t\}ds$$
$$\E_t^{M, \sto}(z)=-\int_0^{t\wedge\tau_\sto} \{\text{Id} + (t-s)\Theta_t\}S^{1/2} dM(s)S^{1/2}\{\text{Id} +(t-s)\Theta_t\}$$
...
\begin{equation*}\max_{i=1, 2, 3, 4} \int_0^{t\wedge \tau_\sto}|\mathcal{G}_{i0, s}|ds\lesssim W^{\frac{\delta_\sto}{5}+2\epsilon} W^{-2}\eta_t^{-\frac{3}{2}}\tag{6.2}\end{equation*}
...
$$\Rightarrow \max_{i=1, \cdots, 4}\int_{0}^{t}|\mathcal{G}_{i1, a}|ds\lesssim W^{\frac{3\delta_\sto}{10}}W^{-2+2\epsilon}\eta_t^{-3/2}\int_{\eta_t}^{\eta_0}\sigma^{-1/2}d\sigma + W^{\frac{3\delta_\sto}{10}+\epsilon}W^{-2}\eta_t^{-1}\int_{\eta_t}^{\eta_0}\sigma^{-1}d\sigma\lesssim$$
...
How does Lemma 20 imply $\E^D_t$ is controlled?
