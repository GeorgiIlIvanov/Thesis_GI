...
\noindent Observe that we have the same primary components differing up to the utmost left and right terms. Hence, we can abstract away four separate matrices, to represent this two-by-two  overlap: 
