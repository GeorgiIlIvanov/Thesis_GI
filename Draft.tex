...
\tag{3.3}
\end{equation*}
 \textcolor{red}{Write \hyperref[lemma-a1]{Lemma A.1} here or transfer}. Now, let $E\in [-10, 10]$ and $\eta\in (0, 10]$. First observe that $|m(z)|\geq c>0$ can never be zero, since it implies: $$m(z) = \frac{-z+\sqrt{z^2-4}}{2}=0 \Leftrightarrow \sqrt{z^2-4}=z$$
...
\label{diffusion}
Recall our time-dependent $T$-equation $T(t)$ and diffusion profile $\Theta_t$. The standard $T$-matrix and diffusion profile $\Theta$ are just the latter two at the end of the spectral curve when $t=1$, i.e: $$T(z)_{ab} = T_{ab} = \sum_{x,y}S_{ax}^{\frac{1}{2}} |G_{xy}|^2S_{yb}^{\frac{1}{2}}$$

$$\Theta := \frac{|m(z)|^2S}{1-|m(z)|^2S}$$
For $z$ in the bulk ($|E|<2$), by \hyperref[3.1]{(3.1)} and  \hyperref[lemma-a1]{Lemma A.1}, $1-|m(z)|^2\asymp \eta\Leftrightarrow \exists \alpha, 1-|m(z)|^2\leq \alpha\eta$, we have that: 
 $$\Theta =\frac{|m(z)|^2S}{1-|m(z)|^2S} = \frac{|m(z)|^2S}{1-|m(z)|^2+|m(z)|^2(S-\text{Id})}\leq   \frac{S}{1-|m(z)|^2+|m(z)|^2(S-\text{Id})}\sim \frac{S}{\alpha\eta+(S-\text{Id})}$$
 
 
 ?\hyperref[lemma-a2]{Lemma A.2} have that $\max_{a,b}\Theta_{ab} \lesssim W^{-1}\eta^{-1/2}$,
