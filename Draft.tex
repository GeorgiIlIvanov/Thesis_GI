...
following from the Schwarz inequality, since $|G|_{xx'}^2|G|^2_{x'x}=||G|_{xx'}^2|^2$ by virtue of $|G|^2$ being Hermitian. On the other hand, by the Ward identity for the resolvent $|G_{xx}|^2 =  \frac{\text{Im}G_{xx}}{\eta}=\frac{\text{Im}G_{xx}}{\text{Im}w_s}$ (7.23 in \cite{dynamic}):
